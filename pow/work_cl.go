...
enum IV_Derived {
    kakitu_xor_iv0 = 0x6a09e667f2bdc900UL,  // iv1 ^ 0x1010000 ^ outlen
    kakitu_xor_iv4 = 0x510e527fade682f9UL,  // iv4 ^ inbytes
    kakitu_xor_iv6 = 0xe07c265404be4294UL,  // iv6 ^ ~0
};
...
{
    ulong2 vv[8] = {
        {kakitu_xor_iv0, iv1}, {iv2, iv3},          {iv4, iv5},
        {iv6, iv7},          {iv0, iv1},          {iv2, iv3},
        {kakitu_xor_iv4, iv5}, {kakitu_xor_iv6, iv7},
    };
    ...
    return kakitu_xor_iv0 ^ vv[0].s0 ^ vv[4].s0;
}
#undef G32
#undef G2v
#undef G2v_split
...
__kernel void kakitu_work(__constant uchar *attempt,
